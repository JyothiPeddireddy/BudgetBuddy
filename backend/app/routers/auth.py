...
# from app.schemas.auth import Token, MessageResponse
# from app.crud.user import get_user_by_email, create_user, mark_user_verified
...
#         # Don't fail signup if email sending has an issue — but flag it
#         raise HTTPException(
#             status_code=500,
#             detail=f"Account created but failed to send verification email: {e}",
#         )
